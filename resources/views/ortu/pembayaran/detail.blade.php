                                ...
                                <div class="col-12">
                                    ...
                                    <div class="invoice p-3 mb-3">
                                        <div class="col-sm-12 invoice-col text-center">
                                            <img src="{{ asset('assets/img/logo-wk.png') }}" alt="" width="80px"
                                                height="80px">
                                        </div>
                                        <!-- info row -->
                                        ...
                                        <div class="row no-print" style="margin-top: 25px">
                                            <div class="col-12">
                                                <h4 class="float-right">Total : Rp
                                                    {{ number_format($detail->total_nominal) }}</h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row no-print" style="margin-top: 25px">
                                            <div class="col-12">
                                                <a href="" onclick="window.print()" class="btn btn-danger"><i
                                                        class="fas fa-print"></i> Print</a>
                                                <a href="" class="btn btn-primary" style="margin-left: 10px;"><i
